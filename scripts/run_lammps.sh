...
micromamba activate grace-lammps

echo "Node(s): $SLURM_JOB_NODELIST"
echo "CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES"
nvidia-smi --query-gpu=index,name,uuid --format=csv,noheader

export LD_LIBRARY_PATH=/home/johannes.karwounopoulos/lammps/build:$LD_LIBRARY_PATH
...
python lammps_npt.py --model_size $model_size --model_type $model_type --sol $sol --default_dtype $default_dtype --layer $layer --dataset $dataset
